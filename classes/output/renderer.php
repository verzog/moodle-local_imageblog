...
class renderer extends plugin_renderer_base {
     ...
     * @return array Numerically indexed: [0] html, [1] text, [2] subject,
     *   [3] array mapping cid => stored_file for inline image embedding.
     */
     ...
     *
     * @param post[] $posts
     * @return array Keyed by 'tags', 'levels', 'authors' and 'images'.
     */
