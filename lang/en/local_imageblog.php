...
$string['author_role_desc']          = 'Grants permission to create, publish and edit the holder\'s own blog posts on the Image blog. Assigned from the admin "Manage blog authors" screen.';
...
$string['case_cpd_enabled']          = 'Award CPD hours for clinical cases';
$string['case_cpd_enabled_desc']     = 'When disabled, no new CPD hours are awarded for case participation, outcome views or best-answer bonuses. Acts as a kill-switch if the CPD rules misfire; existing awards are left untouched.';
...
$string['case_youranswer']           = 'Your answer';
...
$string['lightbox_imagepreview'] = 'Image preview';
$string['likes']                 = '{$a} likes';
$string['manage_authors']            = 'Manage blog authors';
$string['manage_authors_intro']      = 'Users assigned the Blog author role can create, publish and edit their own blog posts. The role is granted at site level.';
...
$string['privacy:deletedpost']                   = 'Blog post (author account erased)';
...
$string['privacy:metadata:subs:timecreated']     = 'When the subscription was created.';
$string['privacy:metadata:subs:timemodified']    = 'When the subscription was last modified.';
