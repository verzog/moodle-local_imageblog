...
$string['digest_hour']              = 'Send digests at';
$string['digest_hour_desc']         = 'Hour of the day (server time) when daily and weekly digest emails are sent. Immediate notifications ignore this setting.';
...
$string['digest_weekday']           = 'Weekly digest day';
$string['digest_weekday_desc']      = 'Day of the week the weekly digest is sent at the configured hour.';
...
$string['error_schedulepast']        = 'Scheduled posts need a future date and time.';
...
$string['frequency']                = 'Email me';
$string['frequency_daily']          = 'Daily digest';
$string['frequency_help']           = 'Choose how often you want to be emailed about new posts. "As soon as published" sends one message per post the moment it goes live. Daily and weekly digests are sent at the time configured by the site administrator.';
$string['frequency_immediate']      = 'As soon as published';
$string['frequency_none']           = 'Don\'t email me';
...
$string['rss_description']  = 'Recent posts published on {$a}.';
$string['rss_disabled']     = 'The blog RSS feed is not enabled on this site.';
$string['rss_enabled']      = 'Publish an RSS feed';
$string['rss_enabled_desc'] = 'When enabled, /local/imageblog/rss.php returns the most recent published posts as an RSS 2.0 feed. The feed is anonymous — only post titles, summaries and links are exposed.';
$string['rss_link']         = 'RSS feed';
...
$string['timescheduled']         = 'Publish at';
$string['timescheduled_help']    = 'When the status is "Scheduled", the post will auto-publish at this date and time. Site managers can edit anyone\'s schedule; blog authors can only schedule their own posts.';
$string['title']                 = 'Title';
